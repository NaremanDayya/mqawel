...
return [
    ...
    'role_in_use' => 'لا يمكن حذف هذا الدور لأنه مستخدم من قبل مستخدمين حاليين.',
    ...
    'activity_file_deleted' => 'حذف ملف ":name"',
    ...
    'notify_on_create' => 'إشعار عند الإضافة',
    'notify_on_create_hint' => 'إرسال إشعار عند إضافة عنصر جديد',
    'notify_on_update' => 'إشعار عند التعديل',
    'notify_on_update_hint' => 'إرسال إشعار عند تعديل عنصر',
    'notify_on_delete' => 'إشعار عند الحذف',
    'notify_on_delete_hint' => 'إرسال إشعار عند حذف عنصر',
    ...
    'import_auto_extracted_hint' => 'تُملأ تلقائياً بعد رفع المستند — يمكن تعديلها.',
    ...
    'manage_sections_description' => 'أضف أو احذف أقسام المستندات حسب احتياج شركتك.',
    'document_sections' => 'الأقسام',
    ...
    'template_file' => 'رفع ملف النموذج',
    'upload_template_file' => 'رفع نموذج',
    'template_file_hint' => 'إذا رفعت ملف Word (docx) يحتوي على حقول دمج بصيغة ${اسم_الحقل}، سيتعرف عليها النظام تلقائياً ويطلب من المستخدم تعبئتها عند إنشاء مستند من هذا النموذج. ملفات PDF أو ملفات Word بلا حقول دمج تُرفق فقط كملف مرجعي دون تعبئة تلقائية.',
    'template_file_prefill_hint' => 'يُملأ تلقائياً بنسخة من ملف النموذج عند استخدامه — يمكن استبداله بملف آخر.',
    'fill_template' => 'تعبئة بيانات النموذج',
