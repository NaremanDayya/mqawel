...
return [
    ...
    'template_file_hint' => "A reference file (Word or PDF) — when this template is used, the new document starts with a copy of this file attached, and the user fills in the rest as usual.",
