...
return [
    ...
    'activity_file_deleted' => 'Deleted file ":name"',
    ...
    'payment_type_salary' => 'Monthly Salary',
    'payment_type_dues' => 'Other Dues',
    ...
    'ai_scan' => 'AI Scan',
    'ai_scan_new_worker_description' => 'Upload an image of the document, and AI will extract the worker\'s data automatically for you to review before saving. The file must be an image (JPG or PNG) only.',
    ...
    'pref_item_project_rows' => 'Per-project rows',
    'pref_item_renew_document' => 'Document renewal alerts',
    'pref_item_complete_worker' => 'Worker profile completion alerts',
    'pref_item_unassigned_inventory' => 'Unclassified inventory alerts',
    'pref_item_donut' => 'Donut chart',
    'pref_item_legend' => 'Details legend',
    'add_user' => 'Add user',
    ...
    'notify_on_create' => 'Notify on add',
    'notify_on_create_hint' => 'Send a notification when a new item is added',
    'notify_on_update' => 'Notify on edit',
    'notify_on_update_hint' => 'Send a notification when an item is edited',
    'notify_on_delete' => 'Notify on delete',
    'notify_on_delete_hint' => 'Send a notification when an item is deleted',
    ...
    'ai_scan_description' => 'Upload an image of the document, and AI will extract the data automatically for you to review before saving. The file must be an image (JPG or PNG) only.',
    ...
    'import_auto_extracted_hint' => 'Auto-filled after uploading the document — can be edited.',
    ...
    'manage_sections_description' => "Add or remove document sections to match your company's needs.",
    ...
    'template_file' => 'Upload Template File',
    'upload_template_file' => 'Upload File',
    'template_file_hint' => 'If you upload a Word (.docx) file containing merge fields like ${field_name}, the system detects them automatically and asks the user to fill them in when creating a document from this template. PDF files, or Word files with no merge fields, are attached as a reference only with no auto-fill.',
    'template_file_prefill_hint' => 'Auto-filled with a copy of the template file when used — can be replaced with a different file.',
    'fill_template' => 'Fill Template Data',
    ...
    'is_transferred' => 'Transferred from another location',
    'transferred_from' => 'Transferred From',
    'transfer_or_purchase_date' => 'Transfer/Purchase Date',
    'performed_by' => 'Performed By',
    'usage_purpose' => 'Usage/Purpose',
    'issue_date' => 'Issue Date',
    'validity_type' => 'File Type',
    'validity_type_permanent' => 'Permanent',
    'validity_type_temporary' => 'Temporary / Renewable',
