            ...
            ->schema([
                ...
                Group::make()->schema([
                    Section::make()->schema([
                        ...
                        ->native(false)          
                        //->locale('ar')
                        ->label(__('backend.damage_date')),
                    ]),
                ]),
                Group::make()->schema([
                    Section::make()->schema([
                        Select::make('responsible')->relationship('responsible', 'name', function($query){
                            $query->where('company_id', Auth::user()->company_id);
                        })->label(__('backend.responsible')),
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('damage_date')->date()->label(__('backend.date')),
