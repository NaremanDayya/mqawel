...
>
    <div class="overflow-x-clip">
        ...
        >
            {{-- Mqwel: the brand block always renders in full (logo, title,
                 tagline), even when the sidebar is collapsed to its icon
                 rail, instead of Filament's default of fully hiding it and
                 showing only the expand chevron. --}}
            <div>
            ...
            {{-- Mqwel: the expand/collapse toggle moved to the topbar (next
                 to the search box) so it's reachable at a fixed spot instead
                 of living inside the sidebar header itself. --}}
        </header>
    </div>
